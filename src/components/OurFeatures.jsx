...
const WhyChooseUs = () => {
  return (
    <section className="w-full bg-[#0f172a] text-white py-20 px-6 my-20">
      <div className="max-w-6xl mx-auto text-center mb-10 py-25 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-6xl mx-auto ">
        {features.map((item, idx) => (
          <div
            key={idx}
            className="bg-[#111c33] border border-white/10 rounded-2xl p-6 hover:scale-[1.02] transition py-15"
          >
